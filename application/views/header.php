	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function waitForMsg()
			{
				...
				{
					type: "GET",
					url: "http://localhost/sms/index.php/pesan/notif",
		...
		<aside id="left-panel">
			...
			<nav>
				...
				<ul>
					...
					<li>
						<a href="widgets.html"><i class="fa fa-lg fa-fw fa-mail-reply-all"></i> <span class="menu-item-parent">Kotak Keluar</span></a>
					</li>
					<li>
						<a href="#"><i class="fa fa-lg fa-fw fa-gear"></i> <span class="menu-item-parent">Settings</span></a>
						<ul>
							<li>
								<a href="calendar.html"> <span class="menu-item-parent">Auto-respond</span></a>
							</li>
							<li>
								<a href="gmap-xml.html"> <span class="menu-item-parent">Auto-send</span></a>
							</li>
						</ul>
					</li>	
